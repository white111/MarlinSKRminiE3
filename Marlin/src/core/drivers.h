...
#if HAS_DRIVER(TMC2208) || HAS_DRIVER(TMC2209) || HAS_DRIVER(TMC2240)
...
#define AXIS_HAS_UART(A) ( AXIS_DRIVER_TYPE(A,TMC2208) || AXIS_DRIVER_TYPE(A,TMC2209) || AXIS_DRIVER_TYPE(A,TMC2240))
