...
#define PARA_SIGN 0x20200707 // If a new setting parameter is added, modify here and initialize the initial value in the "infoSettingsReset()" function
...
void storePara(void)
{
 ...
 // SERIAL_ECHO("storePara\r\n");
  FlashWrite(data, PARA_SIZE);
  // STM32_FlashWrite(data, sizeof(data));
