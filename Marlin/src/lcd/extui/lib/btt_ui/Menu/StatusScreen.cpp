...
static void  redrawPosition(void)
{
  ...
  sprintf(tempstr, "X: %d.%d   Y: %d.%d   Z: %d.%d", (int)statusMsg.x,tempx, (int)statusMsg.y,tempy, (int)statusMsg.z,tempz);
 // sprintf(tempstr, "X: %.2f   Y: %.2f   Z: %.2f", statusMsg.x, statusMsg.y, statusMsg.z);
