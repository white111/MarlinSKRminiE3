...
#define DIGIPOT_MOTOR_CURRENT { 135,135,165,135,135 }   // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 150, 60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
