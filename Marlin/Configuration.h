...
#define STRING_CONFIG_H_AUTHOR "(BIQU, BIQU B1 SE Plus IDEX)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "B1 SE Plus IDEX"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT2 { (X_MAX_POS - 10), (Y_MIN_POS + 10), 20 }
